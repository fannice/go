...
/>
   ...
   <div class="goods-name">{{goodsInfo.NAME}}</div>
    <div class="goods-price">价格：¥{{goodsInfo.PRESENT_PRICE | moneysfilter}} 元</div>
    <van-tabs swipeable sticky class="footer_buttom" >
<van-tab title="商品详情" >
...
<div class="goods-bottom" >
    <div>
            <van-button size="large"  @click="addGoodsToCart" type="primary">加入购物车</van-button>
    </div>
    <div>
